...
RUN apk add curl-dev openssl-dev openssh
####### PHP EXTENSION
...
####### COMPOSER
RUN curl -sS https://getcomposer.org/installer | php -- --install-dir=/usr/bin --filename=composer --version="2.2.5"
